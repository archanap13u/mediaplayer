...
function Videocard({video,res,cond}) {
  ...
  <>
    ...
    <Card.Img variant="top" onClick={handleShow}  style={{ cursor:'pointer',height:"200px"}} src={video?.imageUrl} />
    <Card.Body>
      <Card.Title>{video?.title}</Card.Title>
      {
      !cond &&

      <Button  variant='' onClick={handleDelete} ><i className="fa-solid fa-trash" style={{color: "#fc1d1d",}} /></Button>
      }
